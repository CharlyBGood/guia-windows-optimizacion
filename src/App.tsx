  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 relative z-10">
        <div className="arcade-box mb-8 p-6">
          <div className="flex items-start gap-4 mb-4">
            <HardDrive className="w-7 h-7 text-cyan-400 flex-shrink-0 mt-1" />
            <div>
              <h2 className="text-2xl font-bold text-cyan-300 mb-2">Guía para que puedas limpiar, acelerar y mantener tu PC</h2>
            </div>
          </div>

          <div className="arcade-box-inner bg-black/50 p-4 font-mono text-sm border-2 border-cyan-400">
...
╚══════════════════════════════════════════════════════════╝`}
        ...
        <div className="arcade-box mb-8 p-6">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-yellow-300">Ruta rápida (si tenés poco tiempo)</h3>
            </div>
            <ChevronDown className={`w-6 h-6 transition-transform ${expandedSections.has('quick') ? 'rotate-180' : ''}`} />
          </button>
        ...
        >
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">1.2 Actualizar Windows</h4>
          <ol className="list-decimal list-inside space-y-2 mb-6 ml-4">
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">1.3 Drivers (sin complicarte)</h4>
        ...
        >
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">2.2 Limpieza desde Windows (método recomendado)</h4>
          <ol className="list-decimal list-inside space-y-2 mb-6 ml-4">
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">2.3 Limpieza rápida con teclado (Win + R) — "modo power user"</h4>
          <p className="mb-4">Es normal que Windows no te deje borrar todo: algunos archivos están en uso.</p>

          <div className="space-y-4">
            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Opción A: TEMP del usuario</h5>
              <CodeBlock code="temp" />
              <p className="mt-2">Ctrl + A → Supr → si aparece "no se puede eliminar", elegí <strong>Omitir</strong></p>
            </div>

            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Opción B: %TEMP% (la más típica)</h5>
              <CodeBlock code="%temp%" />
              <p className="mt-2">Ctrl + A → Supr → <strong>Omitir</strong> lo que no se pueda</p>
            </div>

            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Opción C: Prefetch (opcional)</h5>
          ...
          <h4 className="arcade-subtitle text-lg mb-3 mt-6">2.4 Liberador de espacio (método clásico)</h4>
          <ol className="list-decimal list-inside space-y-2 mb-6 ml-4">
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">2.5 Sensor de almacenamiento (automático)</h4>
        ...
        >
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">3.2 Servicios (solo si sos usuario técnico)</h4>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4 mt-4">
            <li>Abrí <code className="px-2 py-1 bg-black/50 border border-cyan-400 rounded">services.msc</code>.</li>
        ...
        >
          <h4 className="text-lg font-bold text-yellow-300 mb-3">4.1 Plan de energía</h4>
          <ol className="list-decimal list-inside space-y-2 mb-6 ml-4">
            <li>Configuración → Sistema → Energía y batería.</li>
            <li>Elegí Mejor rendimiento cuando estés enchufado.</li>
          </ol>

          <h4 className="text-lg font-bold text-yellow-300 mb-3">4.2 Efectos visuales (ideal para PCs modestas)</h4>
          <ol className="list-decimal list-inside space-y-2 mb-6 ml-4">
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">4.3 Apps en segundo plano</h4>
          <ol className="list-decimal list-inside space-y-2 ml-4">
        ...
        >
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">5.2 Optimizar unidades</h4>
          <ol className="list-decimal list-inside space-y-2 ml-4">
        ...
        >
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">6.2 Apps potencialmente no deseadas</h4>
          <ol className="list-decimal list-inside space-y-2 mb-6 ml-4">
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">6.3 Privacidad (recomendaciones seguras desde Configuración)</h4>
          <p className="mb-4 italic">Objetivo: reducir la recolección de datos "extra" sin romper el sistema ni usar scripts raros.</p>

          <div className="space-y-6">
            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Diagnósticos y comentarios</h5>
              <ol className="list-decimal list-inside space-y-2 ml-4">
            ...
            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Historial de actividad y permisos</h5>
              <ol className="list-decimal list-inside space-y-2 ml-4">
            ...
            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Publicidad y sugerencias</h5>
              <ol className="list-decimal list-inside space-y-2 ml-4">
            ...
            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Apps "de relleno" (ej: Contactos / People)</h5>
        ...
        >
          <h4 className="text-lg font-bold text-yellow-300 mb-3">7.1 Restablecer red (si hay problemas)</h4>
          <ol className="list-decimal list-inside space-y-2 mb-6 ml-4">
            <li>Configuración → Red e Internet → Configuración avanzada de red.</li>
            <li>Restablecimiento de red.</li>
          </ol>

          <h4 className="text-lg font-bold text-yellow-300 mb-3">7.2 DNS (opcional)</h4>
        ...
        >
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">8.2 Pestañas y memoria</h4>
          <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        >
          <h4 className="text-lg font-bold text-yellow-300 mb-3">9.1 Escritorio y Descargas</h4>
          <ul className="list-disc list-inside space-y-2 mb-6 ml-4">
            <li>Menos archivos en Escritorio.</li>
            <li>Organizá Descargas y borrá instaladores viejos.</li>
          </ul>

          <h4 className="text-lg font-bold text-yellow-300 mb-3">9.2 Espacio libre</h4>
          <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        >
          ...
          <h4 className="arcade-subtitle text-lg mb-3 mt-6">10.2 DISM (si SFC no alcanza)</h4>
          <p className="mb-4">Ejecutá Terminal o CMD como admin.</p>

          <div className="space-y-4">
            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Paso 1: Chequeos rápidos (no cambian nada)</h5>
            ...
            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Paso 2: Reparar la imagen (el más usado)</h5>
              <CodeBlock code="DISM /Online /Cleanup-Image /RestoreHealth" language="bash" />
            </div>

            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Paso 3 (opcional): Limpieza de componentes</h5>
              <p className="mb-2 italic">Útil si Windows Update se pone pesado o si querés "ordenar" el almacén de componentes.</p>
              <CodeBlock code="DISM /Online /Cleanup-Image /StartComponentCleanup" language="bash" />
            </div>

            <div>
              <h5 className="text-yellow-400 font-bold mb-2">Después de DISM</h5>
              <CodeBlock code="sfc /scannow" language="bash" />
            </div>
          </div>

          <h4 className="arcade-subtitle text-lg mb-3 mt-6">10.3 CHKDSK (revisar y reparar el disco)</h4>
          <div className="space-y-4">
            <div>
          ...
          <InfoBox type="info" icon={<Clock />} title="">
            <p><code className="px-2 py-1 bg-black/50 border border-cyan-400 rounded">chkdsk /r</code> puede tardar bastante. Hacelo cuando no necesites la PC por un rato.</p>
          </InfoBox>
        </Section>
        ...
        <Section
          ...
          icon={<Settings className="w-8 h-8" />}
        >
          <h4 className="text-lg font-bold text-yellow-300 mb-3">11.1 Medir qué está consumiendo</h4>
          <ol className="list-decimal list-inside space-y-2 mb-6 ml-4">
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">11.2 Temperatura (usuarios técnicos)</h4>
          <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        >
          <div className="space-y-6">
            <div>
              <h4 className="arcade-subtitle text-lg mb-2">¿Cuánta RAM necesito?</h4>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Básico: 8 GB.</li>
            ...
            <div>
              <h4 className="arcade-subtitle text-lg mb-2">¿Qué mejora más una PC vieja?</h4>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <div>
              <h4 className="arcade-subtitle text-lg mb-2">¿Formatear es la solución?</h4>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>A veces sí.</li>
        ...
        <Section
          ...
          icon={<HardDrive className="w-8 h-8" />}
        >
          <h4 className="text-lg font-bold text-yellow-300 mb-3">Para qué sirve (en simple)</h4>
          <ul className="list-disc list-inside space-y-2 mb-6 ml-4">
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">Cómo hacerlo con Administrador de discos</h4>
          <ol className="list-decimal list-inside space-y-2 mb-6 ml-4">
          ...
          <h4 className="text-lg font-bold text-yellow-300 mb-3">Tip: mover Documentos/Descargas a D:</h4>
          <ol className="list-decimal list-inside space-y-2 ml-4">
            <li>Explorador de archivos.</li>
            <li>Clic derecho en Documentos → Propiedades.</li>
            <li>Ubicación → Mover… → elegí <code className="px-2 py-1 bg-black/50 border border-cyan-400 rounded">D:\Documentos</code>.</li>
          </ol>
        </Section>
        ...
        <Section
          ...
          icon={<Zap className="w-8 h-8" />}
        >
          <h4 className="text-lg font-bold text-yellow-300 mb-3">16.1 Reinicio "limpio"</h4>
          <p className="mb-4">A veces se siente lenta por días sin reiniciar.</p>
          <ul className="list-disc list-inside space-y-2 mb-6 ml-4">
            <li>Reiniciá (no solo "apagar").</li>
          </ul>

          <h4 className="text-lg font-bold text-yellow-300 mb-3">16.2 Apps residentes</h4>
          <ul className="list-disc list-inside space-y-2 mb-6 ml-4">
            <li>Configuración → Aplicaciones → app → Permisos en segundo plano → Nunca (si aplica).</li>
          </ul>

          <h4 className="text-lg font-bold text-yellow-300 mb-3">16.3 Cuando borrar temporales "no deja"</h4>
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li>Elegí Omitir.</li>
